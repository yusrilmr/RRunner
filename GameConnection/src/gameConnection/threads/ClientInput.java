...
public class ClientInput extends WindowAdapter implements Runnable{
	...
	//constructor
	public ClientInput(DatagramSocket d, String ip, Main ma) throws IOException {
		//initialization
		clientSocket = d;
		...
		KeyListener listener = new KeyListener() {
			...
			public void keyPressed(KeyEvent event) {
				...
				case 39:
					...
					break;
				case 38:
					sendPacket(m.getPlayerNumber() + "-" + String.valueOf(38));
					break;
				}
			}
	...
	public void run(){
		while(true){
			if(sendRight){
				sendPacket(m.getPlayerNumber() + "-" + String.valueOf(39));
			}
			if(sendLeft){
				sendPacket(m.getPlayerNumber() + "-" + String.valueOf(37));
			}
