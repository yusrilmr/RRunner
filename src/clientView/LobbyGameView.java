...
public class LobbyGameView extends JFrame {
...
//		ButtonLeave.addActionListener(uiHandler);
	...
	public static void main(String[] args) {
		LobbyGameView LGV = new LobbyGameView();
	}
